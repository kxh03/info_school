...
import { isUniversityEmail, generateUsername } from "@/utils/auth";
...
const registerSchema = z.object({
  email: z
    ...
    .refine(email => isUniversityEmail(email), {
      message: "Please use your university email (ending with .edu.al)"
    }),
  ...
  async function onSubmit(data: RegisterFormValues) {
    ...
    try {
      ...
      const userData = {
        ...
        username: username,
        university: "Metropolitan", // Default university
      };
      ...
      toast({
        ...
        description: "Welcome to Campus Connections!",
      });
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Use your university email address (username@university.edu.al)
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
